              ...
              <div className="section slide-section">
                <div className="margin-div">
                            ...
                            >
                              ...
                              <h2 className="headline-text">
                                <span className="headline-text-2">
                                  ...
                                  manufacturing, technology, packaging, quality
                                  inspection, and logistics experts that are
                                  Vietnamese locals. We also have a U.S based
                                  headquarters to handle all of the details with
                          ...
                          <Grid item xs={12} className="s1-p1-move">
                            ...
                            <Grid item xs={12} className="">
                              <h2 className="headline-text">
                                <div className="blue-square">2</div>
                                <span className="adjust-left">
                                  Lower cost of living allows for lower wages
                                  and comparatively lower taxes
                                </span>
                              </h2>
                            </Grid>
                            {/*
                  ...
                  <Grid item xs={12} className="home-bot">
                    ...
                    <div>
                      <svg class="arrows" style={{left: "100vw"}}>
                        <path class="a1" d="M0 0 L30 32 L60 0"></path>
                        <path class="a2" d="M0 20 L30 52 L60 20"></path>
                        <path class="a3" d="M0 40 L30 72 L60 40"></path>
                      </svg>
                    ...
                    <div>
                      <svg class="arrows2" style={{right: "100vw"}}>
                        <path class="a1" d="M0 0 L30 32 L60 0"></path>
                        <path class="a2" d="M0 20 L30 52 L60 20"></path>
                        <path class="a3" d="M0 40 L30 72 L60 40"></path>
                      </svg>
